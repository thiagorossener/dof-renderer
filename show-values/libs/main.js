...
function checkControls() {
    if(controls["o"]) {
        ...
        document.querySelector('#focal-length').textContent = cameraFocalDistance;
        resetCanvas();
    }
    if(controls["p"]) {
        cameraFocalDistance += 0.2;
    ...
    if(controls["k"]) {
        ...
        document.querySelector('#bokeh-strength').textContent = bokehStrength;
        resetCanvas();
    }
    if(controls["l"]) {
        bokehStrength -= 0.0025;
    ...
    if(controls["v"]) {
        ...
        document.querySelector('#exposure').textContent = exposure;
    }
    if(controls["b"]) {
        exposure -= 0.0001;
...
// function animate() {
//     if (cameraFocalDistance > 49.19) {
//         cameraFocalDistance -= 0.4;
//         resetCanvas();
